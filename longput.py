...
#endregion
# Passive Strategy
# Reduce Volatility & Downside Risk 
# Investment with Inverse Correlation to Long Position (Delta:-1 ; Vega: + , Risk: Limited)
# Buy Put Options When Expect Decline (Only Buy When (IV is High) ; Vix > 25)
